...
import { Menu, X, LogOut, Settings, Briefcase, MessageSquare, BarChart3, Wallet } from 'lucide-react';
...
export function WorkerLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    { icon: BarChart3, label: 'Dashboard', href: '/dashboard/worker' },
    { icon: Briefcase, label: 'Jobs', href: '/dashboard/worker/jobs' },
    { icon: Wallet, label: 'Earnings', href: '/dashboard/worker/earnings' },
    { icon: MessageSquare, label: 'Messages', href: '/dashboard/worker/messages' },
    { icon: Settings, label: 'Profile', href: '/dashboard/worker/profile' },
  ];
    ...
    <div className="flex h-screen bg-background">
      ...
      >
        <div className="p-4 flex items-center justify-between border-b border-white/20">
          {sidebarOpen && <h1 className="text-xl font-bold">Worker</h1>}
          <button
